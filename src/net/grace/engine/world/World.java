package net.grace.engine.world;
...
import net.grace.engine.nbt.NBTTagCompound;
...
import net.grace.engine.world.chunk.ChunkLoader;
...
import net.grace.toolbox.CompressedStreamTools;
...
import net.grace.toolbox.noise.OpenSimplexNoise;
...
public class World {
	...
	private Thread chunkMeshCreator;
	...
	public void initLevelLoader(String world) {
		...
		chunkMeshCreator = startChunkMeshHandler();
		
		chunkMeshCreator.setName("Chunk Mesh Creator");
		chunkMeshCreator.start();
	}
