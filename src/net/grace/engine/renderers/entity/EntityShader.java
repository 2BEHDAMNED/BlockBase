...
public class EntityShader extends ShaderProgram {
	...
	private static String vertexFile = "/net/grace/engine/renderers/entity/entityVertex.glsl";
	private static String fragmentFile = "/net/grace/engine/renderers/entity/entityFragment.glsl";
